...
train = pd.read_csv('xgboost_benchmark.csv')
...
lasagne_param['max_epochs'] = 5
lasagne_param['dense0_num_units'] = 300
lasagne_param['dense1_num_units'] = 300
lasagne_param['dropout_p'] = 0.5
lasagne_param['num_classes'] = len(encoder.classes_)
